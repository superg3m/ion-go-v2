...
signed char long_to_schar() {
    // 2^62 + 128
    return (signed char)4611686018427388032l;
}

unsigned char long_to_uchar() {
    // UINT_MAX
...
signed char ulong_to_schar() {
    return (signed char)4611686018427388032ul;
}

unsigned char ulong_to_uchar() {
    // 2^63 + 255
...
signed char int_to_schar() {
    // INT_MAX
    return (signed char)2147483647;
}

unsigned char int_to_uchar() {
...
signed char uint_to_schar() {
    return (signed char)2147483660u;  // 2^31 + 12
}

unsigned char uint_to_uchar() {
