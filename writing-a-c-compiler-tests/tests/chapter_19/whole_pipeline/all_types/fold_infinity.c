...
double target_mult_infinity() {
    return (1.0 / 0.0) * 25.;  // infinity
}

double target_mult_neg_infinity() {
    return (-1.0 / 0.0) * 25.;  // negative infinity
}

double target_mult_neg_infinity_by_neg_number() {
...
double target_div_infinity_by_num() {
    return (1. / 0.) / 5.;
}

// negating infinity produces negative infinity
double target_negate_inf() {
