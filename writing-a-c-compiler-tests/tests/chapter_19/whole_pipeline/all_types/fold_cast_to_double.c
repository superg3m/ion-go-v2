...
double target_from_truncated_char() {
    char c = -129;
    return (double)c;  // 127
}
...
// make sure we truncate before converting to double
double target_from_truncated_uchar() {
    unsigned char c = 1000;
    return (double)c;  // 232
}

double target_from_negated_int_zero() {
