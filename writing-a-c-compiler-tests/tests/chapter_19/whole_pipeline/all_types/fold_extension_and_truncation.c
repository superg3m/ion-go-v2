...
long target_extend_int_to_long() {
    int i = -1000;
    long l = (long)i;
...
// same idea as above
unsigned long target_extend_int_to_ulong() {
    int i = -1000;
...
/* Zero extension */
long target_extend_uint_to_long() {
...
unsigned long target_extend_uint_to_ulong() {
...
int target_truncate_long_to_int() {
...
// Test truncation from long to int
// same idea as above
unsigned int target_truncate_long_to_uint() {
...
int target_truncate_ulong_to_int() {
...
unsigned int target_truncate_ulong_to_uint() {
    unsigned long ul = 18446744073709551615UL;  // ULONG_MAX
...
// no-op)
int target_char_int_conversion() {
...
int target_uchar_int_conversion() {
    int i = 767;
...
int target_char_uint_conversion() {
...
int target_uchar_uint_conversion() {
...
int target_char_long_conversion() {
...
int target_uchar_long_conversion() {
...
int target_char_ulong_conversion() {
...
int target_uchar_ulong_conversion() {
    unsigned char uc =
