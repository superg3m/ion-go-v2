...
int test_add_constant_to_pointer() {
...
int test_add_different_index_types() {
...
int test_add_multi_dimensional() {
    static int index = 2;
...
int test_add_to_subarray_pointer() {
    static int index = 2;
    int nested_arr[3][3] = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
...
int test_subtract_from_pointer() {
...
int test_subtract_negative_index() {
...
/* array index can be any integer type, not just int */
int test_subtract_different_index_types() {
 ...
 * variables */
int test_subtract_complex_expressions() {
    static int flag = 1;
    static int four = 4;
    static int arr[4] = {1, 2, 3, 4};
...
int test_subtract_multi_dimensional() {
    static int index = 1;
    int nested_arr[3][3] = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
