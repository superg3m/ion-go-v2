...
struct one_int_reg return_int_struct() {
...
struct two_int_regs return_two_int_struct() {
...
struct one_xmm_reg return_one_xmm_struct() {
...
struct two_xmm_regs return_two_xmm_struct() {
...
struct int_and_xmm return_mixed_struct() {
...
struct stack return_stack_struct() {
...
struct stack_irregular return_irregular_stack_struct() {
...
int test_irregular_stack_struct() {
    // write some bytes to the stack
    struct stack_bytes bytes = {"efghijklmnopqrs"};
