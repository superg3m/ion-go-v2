...
union one_double return_one_double() {
    union one_double result = { 245.5 };
    return result;
}

union one_int_nested return_one_int_nested() {
    union one_int_nested result = { {-9876.5} };
    return result;
}

union has_dbl_struct return_has_dbl_struct() {
...
union two_arrs return_two_arrs() {
...
union scalar_and_struct return_scalar_and_struct() {
...
union xmm_and_gp return_xmm_and_gp() {
...
union contains_union_array return_contains_union_array() {
...
struct has_uneven_union return_struct_with_union() {
