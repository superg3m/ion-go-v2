...
int test_get_struct_pointer_member() {
...
// f()->member = val
struct outer *get_static_struct_ptr() {
    static struct outer s;
    return &s;
}

int test_update_member_thru_retval() {
...
int test_update_nested_struct_thru_retval() {
