...
// case 3: a = x.y.z
int test_copy_from_nested_member() {
...
// case 4: x.y.z = a
int test_copy_to_nested_member() {
...
// case 5: a = (flag ? x : y).z
int test_copy_from_conditional() {
