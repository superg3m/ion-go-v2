...
// case 3: *x = *y
int test_copy_to_and_from_pointer() {
...
// case 6: arr[i] = arr[j]
int test_copy_to_and_from_array_elem() {
    struct s arr[3] = {
        {"ab", {-3000, -4000}}, {"cd", {-5000, -6000}}, {"ef", {-7000, -8000}}};
...
int test_copy_array_element_with_padding() {
