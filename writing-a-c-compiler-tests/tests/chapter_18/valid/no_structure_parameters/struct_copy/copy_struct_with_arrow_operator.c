...
// case 1: x = y->z
int test_copy_from_member_pointer() {
...
// case 2: y->z = x
int test_copy_to_member_pointer() {
...
// case 3: a = x->y->z
int test_copy_from_nested_member_pointer() {
    struct inner small = {99.25, 987654};
...
// case 4: x->y->z = a
int test_copy_to_nested_member_pointer() {
    struct inner small = {99.25, 987654};
    struct outermost *outer_ptr = calloc(1, sizeof(struct outermost));
    outer_ptr->nested_ptr = calloc(1, sizeof(struct outer));
