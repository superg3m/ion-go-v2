...
// then complete it
int test_block_scope_forward_decl() {
...
struct pair *make_struct();
int validate_struct(struct pair *ptr);

int test_file_scope_forward_decl() {
    // call the functions
...
int test_use_incomplete_struct_pointers() {
