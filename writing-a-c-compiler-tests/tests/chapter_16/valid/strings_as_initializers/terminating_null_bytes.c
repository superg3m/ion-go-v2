...
int test_flat_auto_with_null_byte() {
    char flat_auto[2] = "x";
    return (flat_auto[0] == 'x' && flat_auto[1] == 0);
}

int test_nested_auto_with_null_byte() {
...
int test_flat_static_without_null_byte() {
...
int test_nested_static_without_null_byte() {
...
int test_flat_auto_without_null_byte() {
    int x = -1;
...
// storage duration
int test_nested_auto_without_null_byte() {
    char nested[3][3] = {"yes", "no", "ok"};
    char *whole_array = (char *)nested;
    char *word1 = (char *)nested[0];
    char *word2 = (char *)nested[1];
